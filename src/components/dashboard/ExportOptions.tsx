...
export const ExportOptions: React.FC<ExportOptionsProps> = ({ lessonPack }) => {
  const exportTeacherGuide = () => {
    toast.loading('Generating teacher guide...', { id: 'export' });
    ...
    toast.success('Teacher guide downloaded!', { id: 'export' });
  };

  const exportStudentNotes = () => {
    toast.loading('Preparing student notes...', { id: 'student-export' });
...
Generated by ASman Learning - AI Whiteboard Assistant
    ...
    toast.success('Student notes downloaded!', { id: 'student-export' });
  };

  const shareToWhatsApp = () => {
    const message = `🎓 ASman Learning Lesson: ${lessonPack.title}
...
Generated by ASman Learning - AI Whiteboard Assistant for Teachers`;
    ...
    toast.success('Opening WhatsApp to share lesson!');
  };
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Complete lesson plan with AI cues</li>
              <li>• Voice command reference guide</li>
              <li>• Global module integration notes</li>
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            ...
            <ul className="text-sm text-green-700 space-y-1">
              <li>• Simplified lesson summary</li>
              <li>• Key concepts and activities</li>
              <li>• Questions for home discussion</li>
              <li>• WhatsApp-friendly format</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-orange-50 rounded-lg">
          <p className="text-sm text-orange-700 text-center">
            📱 <strong>Teacher Tip:</strong> Share student notes via WhatsApp to keep parents informed about what their children learned today!
          </p>
        </div>
      </div>
    </Card>
